...
params.sra_csv = '/software/projects/pawsey1157/rparraga/setonix/GitHub/sorghum_lncRNA/search/sorghum_runs_all.csv'  // --sra_csv path/to/your.csv
params.prjDir = '/scratch/pawsey1157/rparraga/Sorgum-Project/data_stages' //path to export intermediate outputs
params.genome_library = '/scratch/pawsey1157/rparraga/Sorghum-Project/reference/SofficinarumxspontaneumR570_771_v2.0' //path to hisat2 genome library
params.genome_gtf = '/scratch/pawsey1157/rparraga/Sorghum-Project/reference/SofficinarumxspontaneumR570_771_v2.0.gff3' //path to genome annotation
params.threads = 16
