...
params.sra_csv = '/software/projects/pawsey1157/modanilevicz/setonix/GitHub/sugarcane_lncRNA/search/sugarcane_runs_cleaned.csv'  // --sra_csv path/to/your.csv
params.prjDir = '/scratch/pawsey1157/modanilevicz/sugarcane/nxf_work/data_stages' //path to export intermediate outputs
params.genome_library = '/scratch/pawsey1157/modanilevicz/sugarcane/reference/SofficinarumxspontaneumR570_771_v2.0' //path to hisat2 genome library
params.genome_gtf = '/scratch/pawsey1157/modanilevicz/sugarcane/reference/SofficinarumxspontaneumR570_771_v2.0.gff3' //path to genome annotation
params.threads = 16
