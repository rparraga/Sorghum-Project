...
#SBATCH --time=18:00:00         # time per subtask
#SBATCH --gres=gpu:4
...
mapfile -t FILE_LIST < <(sort -u /scratch/pawsey1157/rparraga/sorghum_lncRNA/script/sorghum_samples.ids)
FILE=${FILE_LIST[$SLURM_ARRAY_TASK_ID]}
echo ${FILE}

## Set environment variables
DIR="/scratch/pawsey1157/rparraga/sorghum/nxf_work/data_stages"
...
REF_ANNO="/scratch/pawsey1157/rparraga/sorghum/reference/annotation.gff3"
...
echo "Start FEELnc"
srun -N 1 -n 1 -c 24 \
        conda run -p /scratch/pawsey1157/modanilevicz/conda_env/feelnc_install \
        FEELnc_filter.pl \
        -i $GTF \
        -a $REF_ANNO \
        --monoex=-1 \
...
srun -N 1 -n 1 -c 24 \
        ...
        -g /scratch/pawsey1157/rparraga/sorghum/Phytozome/PhytozomeV13/Sbicolor/v5.1/annotation/Sbicolor_730_v5.0.fa \
        ${DIR}/candidate_lncRNA/${FILE}/candidate_lncRNA_feelnc.gtf

# Make tRNA and rRNA databases
echo "Generating Blast database of t/rRNAs"
# Check that we have the files needed
if [[ ! -f "/scratch/pawsey1157/rparraga/sorghum/contaminants/other_rnas.fa" ]]; then
        cd /scratch/pawsey1157/rparraga/sorghum/contaminants/
...
if [[ ! -f "/scratch/pawsey1157/rparraga/sorghum/contaminants/other_rna.n*" ]]; then
        cd /scratch/pawsey1157/rparraga/sorghum/contaminants/
...
cd "${DIR}/candidate_lncRNA/${FILE}/"
srun -N 1 -n 1 -c 24 \
        blastn -db /scratch/pawsey1157/rparraga/sorghum/contaminants/other_rnas \
...
rclone copy ${FILE}_lncRNA.zip pawsey1157:sorghumlncrna/rparraga/
